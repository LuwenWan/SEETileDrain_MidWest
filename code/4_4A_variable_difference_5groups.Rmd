...
```{r}
MDA <- read_csv(paste0(dataIndir,"/20240728_RF_R_importance_allPoints_selectVars.csv"),show_col_types = FALSE)
names(MDA)
...
# convert Canal_ditch_dist to km 
data_select4$Canal_ditch_dist <- data_select4$Canal_ditch_dist/1000

## convert to long format
gathercols <- c("Canal_ditch_dist","HLR","SMP_median_summ","SUSM_median_spr","SUSM_range_spr",
                "AET_grow","Aridity_preGrow_3yr","Aridity_spr","Clay_mean_5cm","DayLST_median_grow",
                "DayLST_median_spr","DayLST_range_grow","DayLST_range_spr","DayLST_range_summ",
                "Ksat_mean_5cm","NightLST_max_spr","NightLST_max_summ","Precip_grow","Slope_mean","Soil_drain_class")
...
```{r}
fname <- paste0(datadir,'4A_Variable_Difference_20Vars.png'); fname
ggsave(filename = fname, plot = last_plot(), dpi = 600, width = 7, height = 7) #height = 5

fname <- paste0(datadir,'4A_Variable_Difference_20Vars.pdf'); fname
ggsave(filename = fname, plot = last_plot(), dpi = 600, width = 7, height = 7) #height = 5
...
```{r}
fname <- paste0(datadir,'5A_Variable_Difference_11Vars.png'); fname
ggsave(filename = fname, plot = last_plot(), dpi = 600, width = 7, height = 7) #height = 5

fname <- paste0(datadir, '5A_Variable_Difference_11Vars.pdf'); fname
ggsave(filename = fname, plot = last_plot(), dpi = 600, width = 7, height = 7) #height = 5
```
...
# it seems not as expected that SMP_median_summ in tile area is higher, so we compare them by soil drainage class
